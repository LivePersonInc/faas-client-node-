...
```js
// Option 1: Provide client id and client secret as auth strategy as follows
...
Alternatively you can provide your own authorization method that generates a suitable authorization header. To do so utilise our `GetAuthorizationHeader` type.

How the type `GetAuthorizationHeader` looks like:
```ts
...
Full example:
```ts
// Option 2: Provide your own implementation of our type getAuthorizationHeader
